...
import eu.pb4.buildoff.mixin.BucketItemAccessor;
import eu.pb4.buildoff.mixin.CreativeActionPacketAccessor;
...
public class BbUtils {
    public static Identifier id(String path) {
        return new Identifier("buildoff", path);
    }

    public static MutableText getText(String type, String path, Object... values) {
        return new TranslatableText(Util.createTranslationKey(type, new Identifier("buildoff", path)), values);
    }
    ...
    public static void setCreativeStack(CreativeInventoryActionC2SPacket packet, ItemStack stack) {
        ((CreativeActionPacketAccessor) packet).bo_setStack(stack);
    }
